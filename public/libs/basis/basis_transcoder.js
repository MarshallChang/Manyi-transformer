const BASIS = (function () {
  ...
  return function (BASIS) {
    ...
    const Module = typeof BASIS !== 'undefined' ? BASIS : {};
    ...
    let wasmBinaryFile = 'basis_transcoder.wasm';
    ...
    function __embind_finalize_value_object(structType) {
      ...
      const { rawConstructor } = reg;
      const { rawDestructor } = reg;
      ...
      switch (shift) {
        case 0:
          return function (pointer) {
            const heap = signed ? HEAP8 : HEAPU8;
            return this.fromWireType(heap[pointer]);
          };
        case 1:
          return function (pointer) {
            const heap = signed ? HEAP16 : HEAPU16;
            return this.fromWireType(heap[pointer >> 1]);
          };
        case 2:
          return function (pointer) {
            const heap = signed ? HEAP32 : HEAPU32;
    ...
    function __emval_get_method_caller(argCount, argTypes) {
      ...
      const functionName = makeLegalFunctionName(
